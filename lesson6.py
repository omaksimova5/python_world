...
a = Position('Andrew', 'Ivanov', 'driver', 50000, 20000)
b = Position('Ivan', 'Andreev', 'redactor', 80000, 30000)
...
BMW = PoliceCar(70, 'Green', 'BMW', True)
hyundai = WorkCar(110, 'Blue',  'hyundai', False)
print(BMW.turn_left())
